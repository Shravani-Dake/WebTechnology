...
"Original Array : " + arr6.join(", ") + "<br>" +
"Result Array : " + removeDuplicates(arr6).join(", ");
...
"Array : " + arr5.join(", ") + "<br>" +
"Result  Missing Number = " + findMissingNumber(arr5, n);
...
"Word : " + word + "<br>" +
"Result : " + (isPalindrome(word) ? "Palindrome" : "Not Palindrome");
...
"Number : " + num9 + "<br>" +
"Result : " + (isPalindromeNumber(num9) ? "Palindrome Number" : "Not a Palindrome Number");
...
"String : " + str10 + "<br>" +
"Result : Largest Number = " + findLargestNumberInString(str10);
...
"String : " + str11 + "<br>" +
"Result : Number of Vowels = " + countVowels(str11);
...
let students = [
    { name: "Shravani", age: 20, city: "Pune" },
    { name: "Neha", age: 19, city: "Ichalkaranji" }
];

document.getElementById("activity12").innerHTML =
"<h3>Activity 12 : Array and Object</h3>" +
