...
const gcount = new String("Shravani");
console.log(gcount); //o/p :[String: 'Shravani']
console.log(gcount.length); //o/p : 8

console.log(gcount.toUpperCase());   //o/p : SHRAVANI

console.log(gcount.toLowerCase());  //o/p : shravani
